...
Type
  ...
  Private
    ...
    Function WideStuffString(Source: String; Start, Len: Integer;
...
Begin
  ...
  Repeat
    ...
    If ((wT = b_s) Or (wT = b_ss) Or (wT = b_m) Or (wT = b_n) Or (wT = b_d) Or
      (wT = A_M_1H) Or (wT = A_Ss_1H) Or (wT = A_S_1H_1) Or (wT = A_N_1H_1) Or
      (wT = A_D_1H_2)) Then
  ...
  Repeat
    ...
    If I <= 0 Then
      break;
    wT := MidStr(fConvertedText, I - 1, 1);
    If ((wT = A_M_1H) Or (wT = A_Ss_1H) Or (wT = A_C_1H) Or (wT = A_S_1H_1) Or
      (wT = A_D_1H_2) Or (wT = A_N_1H_1) Or (wT = A_N_1H_2)) Then
...
Begin
  { A_M_1H }
  fConvertedText := ReplaceStr(fConvertedText, b_m + b_Hasanta,
    A_M_1H + b_Hasanta);
  { A_Ss_1H }
  fConvertedText := ReplaceStr(fConvertedText, b_ss + b_Hasanta,
    A_Ss_1H + b_Hasanta);
  { A_C_1H }
  fConvertedText := ReplaceStr(fConvertedText, b_C + b_Hasanta,
    A_C_1H + b_Hasanta);
  { A_NGA_1H }
  fConvertedText := ReplaceStr(fConvertedText, b_NGA + b_Hasanta,
    A_NGA_1H + b_Hasanta);
  { A_S_1H_1 }
  fConvertedText := ReplaceStr(fConvertedText, b_s + b_Hasanta,
    A_S_1H_1 + b_Hasanta);
  ...
  Repeat
    ...
    If ((MidStr(fConvertedText, I + 2, 1) = b_t) Or
      ...
      (MidStr(fConvertedText, I + 2, 1) = b_L) Or (MidStr(fConvertedText, I + 2,
      1) = b_b) Or (MidStr(fConvertedText, I + 2, 1) = A_T_R_2H) Or
      (MidStr(fConvertedText, I + 2, 1) = A_T_UKar_2H)) Then
      fConvertedText[I] := A_N_1H_1
    Else If (MidStr(fConvertedText, I + 2, 1) = b_m) Or
      (MidStr(fConvertedText, I + 2, 1) = b_n) Then
...
Begin
  ...
  fConvertedText := ReplaceStr(fConvertedText, '­', 'ø');
  fConvertedText := ReplaceStr(fConvertedText, 'K­', 'K¬');
  fConvertedText := ReplaceStr(fConvertedText, 'š—', 'šÍ');
  fConvertedText := ReplaceStr(fConvertedText, 'i“', 'iæ');
  fConvertedText := ReplaceStr(fConvertedText, '“', 'æ');
  ...
  fConvertedText := ReplaceStr(fConvertedText, 'ø“', 'øz');
  fConvertedText := ReplaceStr(fConvertedText, '¬y', '¬z');
...
Begin
  ...
  fConvertedText := ReplaceStr(fConvertedText, b_K + b_Hasanta + b_ss +
    b_Hasanta + b_m, A_K_Ss_M);
  ...
  fConvertedText := ReplaceStr(fConvertedText, b_NGA + b_Hasanta + b_K,
    A_NGA_K);
  fConvertedText := ReplaceStr(fConvertedText, b_NGA + b_Hasanta + b_g,
    A_NGA_G);
  ...
  fConvertedText := ReplaceStr(fConvertedText, b_j + b_Hasanta + b_nya,
    A_J_NYA);
  fConvertedText := ReplaceStr(fConvertedText, b_nya + b_Hasanta + b_C,
    A_NYA_C);
  fConvertedText := ReplaceStr(fConvertedText, b_nya + b_Hasanta + b_ch,
    A_NYA_CH);
  fConvertedText := ReplaceStr(fConvertedText, b_nya + b_Hasanta + b_j,
    A_NYA_J);
  fConvertedText := ReplaceStr(fConvertedText, b_nya + b_Hasanta + b_jh,
    A_NYA_Jh);
  fConvertedText := ReplaceStr(fConvertedText, b_tt + b_Hasanta + b_tt,
    A_Tt_Tt);
  fConvertedText := ReplaceStr(fConvertedText, b_dd + b_Hasanta + b_dd,
    A_Dd_Dd);
  fConvertedText := ReplaceStr(fConvertedText, b_Nn + b_Hasanta + b_tt,
    A_Nn_Tt);
  fConvertedText := ReplaceStr(fConvertedText, b_Nn + b_Hasanta + b_tth,
    A_Nn_Tth);
  fConvertedText := ReplaceStr(fConvertedText, b_Nn + b_Hasanta + b_dd,
    A_NN_Dd);
  ...
  fConvertedText := ReplaceStr(fConvertedText, b_n + b_Hasanta + b_tth,
    A_N_Tth);
  ...
  fConvertedText := ReplaceStr(fConvertedText, b_sh + b_Hasanta + b_ch,
    A_Sh_Ch);
  fConvertedText := ReplaceStr(fConvertedText, b_ss + b_Hasanta + b_Nn,
    A_Ss_Nn);
  fConvertedText := ReplaceStr(fConvertedText, b_ss + b_Hasanta + b_tt,
    A_Ss_Tt);
  fConvertedText := ReplaceStr(fConvertedText, b_ss + b_Hasanta + b_tth,
    A_Ss_Tth);
  fConvertedText := ReplaceStr(fConvertedText, b_ss + b_Hasanta + b_ph,
    A_Ss_Ph);
...
Begin
  Result := False;
  If (wC = b_kh) Or (wC = b_g) Or (wC = b_gh) Or (wC = b_Nn) Or (wC = b_Th) Or
    (wC = b_d) Or (wC = b_dh) Or (wC = b_n) Or (wC = b_p) Or (wC = b_b) Or
    (wC = b_m) Or (wC = b_z) Or (wC = b_r) Or (wC = b_L) Or (wC = b_sh) Or
    (wC = b_ss) Or (wC = b_s) Or (wC = b_h) Or (wC = b_y) Then
    Result := True;
...
Begin
  ...
  Repeat
    ...
    If I <= 0 Then
      break;
    { P/G + RoFola }
    If ((MidStr(fConvertedText, I - 1, 1) = b_p) Or
      (MidStr(fConvertedText, I - 1, 1) = b_g)) Then
    ...
    Begin
      ...
      Begin
        ...
        If (MidStr(fConvertedText, I - 3, 1) = b_K) Or
          (MidStr(fConvertedText, I - 3, 1) = b_t) Then
    ...
    Begin
      ...
      Begin // Kar is pending
        ...
        Begin // Not begining of text, search backward more deeply
          If ((IsPureConsonent(wCTmp) = False) And (wCTmp <> b_Hasanta) And
            (wCTmp <> zwj) And (wCTmp <> zwnj)) Then
          Begin
          ...
          Begin
            ...
            Begin
              If ((fConvertedText[I - 1] = b_Hasanta) Or
                (fConvertedText[I - 1] = zwj) Or
                (fConvertedText[I - 1] = zwnj)) Then
                wSTmp := wCTmp + wSTmp
              Else
              Begin
                wSTmp := fKar + wCTmp + wSTmp;
...
Var
  ...
  Begin
    ...
    If I + 2 > Length(fConvertedText) Then
      exit;
    If ((fConvertedText[I] = b_r) And (fConvertedText[I + 1] = b_Hasanta) And
      (fConvertedText[I + 2] <> zwj) And (fConvertedText[I + 2] <> zwnj)) Then
      Result := True;
  End;
...
Begin
  ...
  Repeat
    ...
    If I <= 0 Then
      break;
    If ((I = 1) Or (MidStr(fConvertedText, I - 1, 1) = ' ') Or
      (MidStr(fConvertedText, I - 1, 1) = #13) Or (MidStr(fConvertedText, I - 1,
      1) = #10) Or (MidStr(fConvertedText, I - 1, 1) = #9)) Then
  ...
  fConvertedText := ReplaceStr(fConvertedText, b_Hasanta + b_t + b_Ukar,
    b_Hasanta + A_T_UKar_2H);
  Repeat
    ...
    Begin
      ...
      Begin
        ...
        Begin
          If ((MidStr(fConvertedText, I - 3, 3) = b_sh + b_Hasanta + b_r) Or
            ...
            (MidStr(fConvertedText, I - 5, 5) = b_n + b_Hasanta + b_d +
            b_Hasanta + b_r) Or (MidStr(fConvertedText, I - 3, 3) = b_p +
            b_Hasanta + b_r) Or (MidStr(fConvertedText, I - 3, 3) = b_b +
            b_Hasanta + b_r) Or (MidStr(fConvertedText, I - 3, 3) = b_Bh +
            b_Hasanta + b_r) Or (MidStr(fConvertedText, I - 3, 3) = b_m +
            b_Hasanta + b_r) Or (MidStr(fConvertedText, I - 3, 3) = b_s +
            b_Hasanta + b_r) Or (MidStr(fConvertedText, I - 5, 5) = b_m +
            b_Hasanta + b_p + b_Hasanta + b_r) Or (MidStr(fConvertedText, I - 5,
            5) = b_ss + b_Hasanta + b_p + b_Hasanta + b_r) Or
            (MidStr(fConvertedText, I - 5, 5) = b_s + b_Hasanta + b_p +
            b_Hasanta + b_r)) Then
      ...
      Else
      Begin
        If ((fConvertedText[I - 1] = b_rr) Or
          (fConvertedText[I - 1] = b_rrh)) Then
        Begin
...
Function TUnicodeToBijoy2000.WideStuffString(Source: String;
  Start, Len: Integer; SubString: String): String;
Var
